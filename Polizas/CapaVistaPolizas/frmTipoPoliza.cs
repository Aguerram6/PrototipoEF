...
namespace CapaVistaPolizas
{
    public partial class frmTipoPoliza : Form
    {
        ...
        {
            Help.ShowHelp(this, "AyudasPolizas/AyudasPoliza.chm", "Pólizas-Contables.html");
        }

        private void button1_Click(object sender, EventArgs e)
        {
            CapaVistaPolizas.ReporteTipoPoliza formulario = new CapaVistaPolizas.ReporteTipoPoliza();
            formulario.Show();
        }
    }
}
